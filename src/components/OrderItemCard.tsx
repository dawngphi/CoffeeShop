...
const OrderItemCard: React.FC<OrderItemCardProps> = ({ type, name, imagelink_square, special_ingredient, prices, ItemPrice }) => {
    return (
        <View>
            <LinearGradient
                start={{ x: 0, y: 0 }}
                    ...
                    <View key={index.toString()} style = {styles.CardTableRow}>
                        <View style = {styles.CardTableRow}>
                            ...
                            <View style = {styles.PriceBoxRight}>
                                <Text style = {styles.PriceCurrency}><Text style = {styles.Price}>{data.currency}</Text>{data.price}</Text>
                            </View>
                        </View>
                        <View style = {styles.CardTableRow}>
